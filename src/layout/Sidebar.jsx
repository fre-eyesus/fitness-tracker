...
const Sidebar = () => {
  return (
    <aside className="ml-5 w-full max-w-[300px] bg-[#EEEEEE] p-4 flex flex-col space-y-6 text-gray-800 rounded-lg md:max-lg:mx-auto md:max-lg:mt-10 md:max-lg:w-full">
